...
class Mobusers_model extends CI_Model
{
    ...
    public function getBeritaSlide()
    {
        ...
        $query = $this->db->get($this, 'mob_berita', 5)->result_array();
        return $query;
    }
    ...
    {
        $this->db->order_by("id", "ASC");
        $query = $this->db->get($this, 'mob_berita')->result_array();
        return $query;
    }

    public function getTiketEvent()
    {
        return $this->db->get_where('mob_tiket_event', array('is_active' => 1))->result_array();
    }
    ...
    {
        return $this->db->get_where('mob_tiket_pertandingan', array('is_active' => 1))->result_array();
    }
    ...
    public function getOrderTiketDtlEvent($id_order)
    {
    ...
    public function getOrderTiketDtlPertandingan($id_order)
    {
        $query = "SELECT IF(`mob_order_tiket`.`jenis_tiket` = 'TIKETPTN', 'Tiket Pertandingan', 'Tiket Event') AS `jenis_tiket`,
                         `mob_generate_qr`.`id`,
                         `mob_generate_qr`.`qr_code`,
