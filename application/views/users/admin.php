                        ...
                        <tbody>
                            ...
                            <?php foreach ($user as $u) { ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php if ($u['role_id'] != '1') {
                                                echo "<button class='btn-link d-edit' data-toggle='modal' data-target='#modal_edit_user_$u[id]' title='Edit'>
                                                <i class='fa fa-edit' style='color:green'></i>
                                            </button>
                                            &nbsp;
                                            <a title='Delete' href='delete_users/$u[id]' onclick='return confirm('Anda yakin ingin menghapus data ini?')' type='button' class='btn-link d-delete'>
        ...
        <div id="modal_edit_user_<?= $u['id'] ?>" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('admin/edit_users'); ?>" method="post">
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="usr">Name :</label>
